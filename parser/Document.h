...
class QTMARKDOWNSHARED_EXPORT Node {
 public:
  explicit Node(NodeType type = NodeType::none, Node* parent = nullptr)
...
class QTMARKDOWNSHARED_EXPORT CheckboxItem
...
class QTMARKDOWNSHARED_EXPORT Text : public Visitable<Text> {
 public:
  Text(SizeType offset, SizeType length) : m_offset(offset), m_length(length) {
...
class QTMARKDOWNSHARED_EXPORT ItalicText : public Visitable<ItalicText> {
 public:
  explicit ItalicText(Text* text) : m_text(text) {
...
class QTMARKDOWNSHARED_EXPORT BoldText : public Visitable<BoldText> {
 public:
  explicit BoldText(Text* text) : m_text(text) {
...
class QTMARKDOWNSHARED_EXPORT ItalicBoldText
    : public Visitable<ItalicBoldText> {
 public:
  explicit ItalicBoldText(Text* text) : m_text(text) {
...
class QTMARKDOWNSHARED_EXPORT StrickoutText : public Visitable<StrickoutText> {
 public:
  explicit StrickoutText(Text* text) : m_text(text) {
...
class QTMARKDOWNSHARED_EXPORT CodeBlock : public ContainerVisitable<CodeBlock> {
 public:
  explicit CodeBlock(Text* name) : m_name(name) {
...
class QTMARKDOWNSHARED_EXPORT LatexBlock
    : public ContainerVisitable<LatexBlock> {
 public:
...
class QTMARKDOWNSHARED_EXPORT InlineCode : public Visitable<InlineCode> {
 public:
  explicit InlineCode(Text* code) : m_code(code) {
